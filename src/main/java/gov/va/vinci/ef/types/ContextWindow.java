...
public class ContextWindow extends Window {
  ...
  public final static int typeIndexID = JCasRegistry.register(ContextWindow.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ContextWindow() {/* intentionally empty block */}
   ...
   */
  public ContextWindow(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public ContextWindow(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public ContextWindow(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
