 ...
 * @generated */
public class TNMMeasurement extends Link {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(TNMMeasurement.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected TNMMeasurement() {/* intentionally empty block */}
   ...
   */
  public TNMMeasurement(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public TNMMeasurement(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public TNMMeasurement(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
