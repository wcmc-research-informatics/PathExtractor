 ...
 * @generated */
public class GSRelation extends Link {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(GSRelation.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected GSRelation() {/* intentionally empty block */}
   ...
   */
  public GSRelation(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public GSRelation(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
