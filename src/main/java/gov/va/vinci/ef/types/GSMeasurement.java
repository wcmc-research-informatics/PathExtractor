 ...
 * @generated */
public class GSMeasurement extends Link {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(GSMeasurement.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected GSMeasurement() {/* intentionally empty block */}
   ...
   */
  public GSMeasurement(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public GSMeasurement(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public GSMeasurement(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
