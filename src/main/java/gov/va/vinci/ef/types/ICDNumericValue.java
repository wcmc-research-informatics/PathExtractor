 ...
 * @generated */
public class ICDNumericValue extends Link {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(ICDNumericValue.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ICDNumericValue() {/* intentionally empty block */}
   ...
   */
  public ICDNumericValue(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public ICDNumericValue(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public ICDNumericValue(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
