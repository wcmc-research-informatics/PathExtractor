 ...
 * @generated */
public class TNMNumericValue extends Link {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(TNMNumericValue.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected TNMNumericValue() {/* intentionally empty block */}
   ...
   */
  public TNMNumericValue(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public TNMNumericValue(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public TNMNumericValue(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
