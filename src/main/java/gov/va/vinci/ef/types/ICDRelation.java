 ...
 * @generated */
public class ICDRelation extends Link {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(ICDRelation.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ICDRelation() {/* intentionally empty block */}
   ...
   */
  public ICDRelation(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public ICDRelation(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
