 ...
 * @generated */
public class ICDMeasurement extends Link {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(ICDMeasurement.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ICDMeasurement() {/* intentionally empty block */}
   ...
   */
  public ICDMeasurement(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public ICDMeasurement(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public ICDMeasurement(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
