 ...
 * @generated */
public class EfRelation extends Link {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(EfRelation.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected EfRelation() {/* intentionally empty block */}
   ...
   */
  public EfRelation(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public EfRelation(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
