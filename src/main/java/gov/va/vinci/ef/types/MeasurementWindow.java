...
public class MeasurementWindow extends Window {
  ...
  public final static int typeIndexID = JCasRegistry.register(MeasurementWindow.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected MeasurementWindow() {/* intentionally empty block */}
   ...
   */
  public MeasurementWindow(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public MeasurementWindow(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public MeasurementWindow(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
