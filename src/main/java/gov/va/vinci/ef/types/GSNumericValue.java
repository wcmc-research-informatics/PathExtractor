 ...
 * @generated */
public class GSNumericValue extends Link {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(GSNumericValue.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected GSNumericValue() {/* intentionally empty block */}
   ...
   */
  public GSNumericValue(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public GSNumericValue(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public GSNumericValue(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
