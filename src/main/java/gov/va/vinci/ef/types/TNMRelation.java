 ...
 * @generated */
public class TNMRelation extends Link {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(TNMRelation.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected TNMRelation() {/* intentionally empty block */}
   ...
   */
  public TNMRelation(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public TNMRelation(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
